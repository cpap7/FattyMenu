...
void CPSOP::RenderCivilProtectionSOP() {
	...
	GUIUtils::RenderSOPSection("<:: CODE INDEX ::>", [] {
	...
	GUIUtils::RenderSOPSection("<:: CIVIC REWARD & INTERACTION INDEX ::>", [] {
	...
	GUIUtils::RenderSOPSection("<:: TERMINOLOGY INDEX ::>", [] {
	...
	GUIUtils::RenderSOPSection("<:: CONTRABAND INDEX ::> ", [] {
