...
namespace FattyMenu {
	namespace TFSOPLookupTables {
		...
		static const std::vector<CTerm> tf_hostile_entity_list = {
			TFTerminology::HostileEntity::contaminant,
			TFTerminology::HostileEntity::exogen,
			TFTerminology::HostileEntity::parasitic,
			TFTerminology::HostileEntity::necrotic,
			TFTerminology::HostileEntity::viromes
		};
