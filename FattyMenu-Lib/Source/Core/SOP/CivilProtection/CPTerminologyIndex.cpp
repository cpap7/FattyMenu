...
namespace FattyMenu {
	...
	* Format: CTerm term_name = { "Term name", "Term description" }
	*/
	namespace CPTerminology {

		// Protocol code definitions
		namespace Protocol {
			CTerm emergency_code				= { "Emergency code", "Rules of operation during a priority emergency" };
			CTerm overload_protocol				= { "Overload protocol", "A directive to use maximum force to contain or neutralize the situation" };
			CTerm prosecution_code				= { "Prosecution code", "Rules of operation for teams called to prosecute an individual" };
			CTerm response_code					= { "Response code", "Required form of response to a given situation and its level of urgency" };
			CTerm sacrifice_code				= { "Sacrifice code", "Achieve the given task even if it equates to certain death" };
		}

		// Action code definitions
		namespace Action {
			CTerm administer					= { "Administer", "Manage or apply procedures for control or compliance" };
			CTerm amputate						= { "Amputate", "Execute, used metaphorically to describe cutting off parts of a group or structure" };
		...
		namespace ActionCondition {
			...
			CTerm tag							= { "Tag", "To confirm a kill or identify a target."};
		}
		...
		namespace Hostile {
			...
			CTerm malignant						= { "Malignant", "Used to describe a criminally active or a malicious force / threat" };
		...
		namespace EquipmentAsset {
			CTerm containment_field				= { "Containment field", "Refers to a Combine force field used to seal or separate areas" };
			CTerm ground_unit					= { "Ground unit", "Refers to any Overwatch personnel operating on the ground" };
			CTerm protection_team				= { "Protection team", "Refers to a squad of metro cops" };
		...
		namespace Organizations {
			// TODO: display airwatch -> synths as bullet points under combine overwatch
			CTerm combine_overwatch				= { "Combine Overwatch", "The Combine's joint humanoid military and police forces on Earth" };
			...
			// TODO: display industrial workforce -> security council under civic populace as bullet points
			...
			// TODO: display science core as sub bullet point under infestation control
		...
		namespace Sociostability {
			...
			CTerm malcompliance					= { "Malcompliance", "Disobedience or failure to cooperate" };
		...
		namespace Areas {
			CTerm block							= { "Block", "A small area in the city or a Combine installation or outpost" };
			CTerm canal_block					= { "Canal block", "The part of the canals that's still within the city limits" };
			...
			CTerm transit_block					= { "Transit block", "Bus or train station area" };
			CTerm polity						= { "Polity", "City or urban center" };
			CTerm production_block				= { "Production block", "Factory or warehouse area" };
			...
			CTerm infested_zone					= { "Infested zone", "An area infested by alien presence containing parasites or Xen growth" };
			...
			CTerm nexus							= { "Nexus", "A command center for the Combine Overwatch's forces in a given region" };
