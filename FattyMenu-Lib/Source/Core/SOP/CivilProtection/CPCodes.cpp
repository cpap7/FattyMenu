...
namespace FattyMenu {
	namespace CPCodes {
		...
		CCode code_name = {
			"Title or Name",
			"Description",
			 EECodeType::Type // See CCode.cpp for enum class definition
		};
		*/
		...
		namespace Response {
			CCode code_1	= { "Code 1", "Non-urgent-response at your convenience", ECodeType::ResponseCode };
			CCode code_2	= { "Code 2", "Urgent-response if not under assignment", ECodeType::ResponseCode };
			CCode code_3	= { "Code 3", "Emergency, respond immediately", ECodeType::ResponseCode };
			CCode code_4	= { "Code 4", "No further assistance required", ECodeType::ResponseCode };
			CCode code_7	= { "Code 7", "Out of service to eat or resupply ammunition", ECodeType::ResponseCode };
			CCode code_12	= { "Code 12", "Patrol your district and report the extent of damage", ECodeType::ResponseCode };
			CCode code_100	= { "Code 100", "In position to intercept suspect", ECodeType::ResponseCode };
		}

		namespace Eleven {
			CCode _116		= { "11-6", "Illegal discharge of firearms", ECodeType::ElevenCode };
			CCode _1142		= { "11-42", "Medical team not required", ECodeType::ElevenCode };
			CCode _1143		= { "11-43", "Medical team required", ECodeType::ElevenCode };
			CCode _1144		= { "11-44", "Cleanup team required", ECodeType::ElevenCode };
			CCode _1194		= { "11-94", "Pedestrian stop", ECodeType::ElevenCode };
			CCode _1199		= { "11-99", "Officer needs immediate help", ECodeType::ElevenCode };
		}

		namespace Ten {
			CCode _100		= { "10-0", "Use caution", ECodeType::TenCode };
			CCode _101		= { "10-1", "You are being received poorly", ECodeType::TenCode };
			CCode _102		= { "10-2", "You are being received clearly", ECodeType::TenCode };
			CCode _103		= { "10-3", "Stop transmitting", ECodeType::TenCode };
			CCode _104		= { "10-4", "Affirmative", ECodeType::TenCode };
			CCode _106		= { "10-6", "Busy", ECodeType::TenCode };
			CCode _107		= { "10-7", "Out of service", ECodeType::TenCode };
			CCode _108		= { "10-8", "In service", ECodeType::TenCode };
			CCode _109		= { "10-9", "Repeat message", ECodeType::TenCode };
			CCode _1012		= { "10-12", "Standby", ECodeType::TenCode };
			CCode _1014		= { "10-14", "Convoy or escort detail", ECodeType::TenCode };
			CCode _1015		= { "10-15", "Prisoner in custody", ECodeType::TenCode };
			CCode _1019		= { "10-19", "Returning to station", ECodeType::TenCode };
			CCode _1020		= { "10-20", "Your location", ECodeType::TenCode };
			CCode _1022		= { "10-22", "Disregard", ECodeType::TenCode };
			CCode _1025		= { "10-25", "Contact with [Suspect]", ECodeType::TenCode };
			CCode _1026		= { "10-26", "Detaining suspect", ECodeType::TenCode };
			CCode _1027		= { "10-27", "Check if person is of interest", ECodeType::TenCode };
			CCode _1030		= { "10-30", "Non-conformance/danger", ECodeType::TenCode };
			CCode _1031		= { "10-31", "In pursuit", ECodeType::TenCode };
			CCode _1032		= { "10-32", "Armed suspect", ECodeType::TenCode };
			CCode _1033		= { "10-33", "Alarm", ECodeType::TenCode };
			CCode _1038		= { "10-38", "Your destination", ECodeType::TenCode };
			CCode _1041		= { "10-41", "Begin duty", ECodeType::TenCode };
			CCode _1042		= { "10-42", "End duty", ECodeType::TenCode };
			CCode _1054d	= { "10-54d", "Possible dead body", ECodeType::TenCode };
			CCode _1065		= { "10-65", "Clear for assignment", ECodeType::TenCode };
			CCode _1078		= { "10-78", "Medical assistance", ECodeType::TenCode };
			CCode _1091d	= { "10-91", "Dead animal", ECodeType::TenCode };
			CCode _1093		= { "10-93", "Blockade [in the road]", ECodeType::TenCode };
			CCode _1096		= { "10-96", "Mentally unfit", ECodeType::TenCode };
			CCode _1097		= { "10-97", "Arrived at scene", ECodeType::TenCode };
			CCode _1099		= { "10-99", "Officer in trouble [Last in squad]", ECodeType::TenCode };
			CCode _10103	= { "10-103", "Disturbance", ECodeType::TenCode };
			CCode _10103m	= { "10-103m", "Disturbance by mentally unfit", ECodeType::TenCode };
			CCode _10107	= { "10-107", "Suspicious person", ECodeType::TenCode };
			CCode _10108	= { "10-108", "Officer down", ECodeType::TenCode };
			CCode _10109	= { "10-109", "Suicide", ECodeType::TenCode };
		}
