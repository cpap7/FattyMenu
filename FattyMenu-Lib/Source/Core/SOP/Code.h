...
namespace FattyMenu {
	...
	private:
		...
		const char* m_code_violation_description	= "";						// Description of the code violation
	...
	public:
		...
		inline void SetViolationDescription(const char* a_code_violation_description)				{ m_code_violation_description	= a_code_violation_description;	}
		...
		inline const char* GetViolationDescription() const											{ return m_code_violation_description;							}
